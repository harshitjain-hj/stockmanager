...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card">
                <div class="card-header text-center">ADD BILL</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('sale.update', $sale->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="bill_no" type="text" class="form-control @error('bill_no') is-invalid @enderror" name="bill_no" value="{{ old('bill_no') ?? $sale->bill_no }}" required autocomplete="bill_no" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" value="{{ old('description') ?? $sale->description }}" name="description" autocomplete="description">
