                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('sale.store') }}" onsubmit="add.disabled = true; return true;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="bill_no" type="text" class="form-control @error('bill_no') is-invalid @enderror" name="bill_no" value="{{ old('bill_no') ?? $bill_no }}" required autocomplete="bill_no">
                        ...
                        <div class="card alert-warning text-body pt-3 mb-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="qty" type="text" class="form-control @error('qty') is-invalid @enderror" name="qty" value="{{ old('qty') }}" autocomplete="qty">
